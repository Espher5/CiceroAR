...
public class ArActivity extends AppCompatActivity {
    ...
    private final Painting painting = getPainting();
    ...
    private void narrate() {
        painting.getPaintingInfo()
                .entrySet()
                .forEach(entry -> ttsManager.speak(entry.getValue(), entry.getKey()));
    }
    ...
    ** Test painting setup
    ...
    private Painting getPainting() {
        Map<String, String> paintingInfo = new LinkedHashMap<>();
        paintingInfo.put("default", "The main focus of the composition is the goddess of love and beauty, Venus. " +
        ...
        paintingInfo.put("Venus", "The goddess is standing on a giant scallop shell, as pure and perfect as a pearl. " +
        ...
        paintingInfo.put("Shell", "You may wonder why Venus is standing on a shell; the story goes that the God Uranus had a son named Chronus, " +
        ...
        paintingInfo.put("Zephyrus", "In the top left of the piece we can notice Zephyrus, god of the winds; " +
        ...
        paintingInfo.put("Aura", "The Hora herself may be a complementary version of the nymph Chloris. " +
